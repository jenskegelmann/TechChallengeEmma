...
class ViewController: UIViewController {
    ...
    var tokenUrl = "https://redwood-salmon-9468.twil.io/video-token?identity=patient"
    ...
    @IBOutlet weak var callInfo: UIStackView!
    ...
    @IBAction func connect(sender: AnyObject) {
        ...
        let connectOptions = TVIConnectOptions.init(token: accessToken) { (builder) in
            ...
            builder.roomName = "emma"
        }
        
        // Connect to the Room using the options we provided.
        room = TwilioVideo.connect(with: connectOptions, delegate: self)
        
        logMessage(messageText: "Attempting to connect to room emma")
    ...
    @IBAction func disconnect(sender: AnyObject) {
        ...
        logMessage(messageText: "Attempting to disconnect from room emma")
    }
